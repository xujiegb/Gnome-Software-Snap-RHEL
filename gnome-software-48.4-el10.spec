...
rm -f %{buildroot}%{_libdir}/gnome-software/plugins-%{gs_plugin_version}/libgs_plugin_dpkg.so
rm -f %{buildroot}%{_libdir}/gnome-software/plugins-%{gs_plugin_version}/libgs_plugin_dummy.so
...
%changelog
* Wed Aug 27 2025 Milan Crha <mcrha@redhat.com> - 48.4-1
- Update to 48.4
- Enable Snap plugin in main package
...
* Sat Aug 01 2020 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.36.1-3
- Second attempt - Rebuilt for
  https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Mon Jul 27 2020 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.36.1-2
...
* Fri Feb 21 2020 Richard Hughes <richard@hughsie.com> - 3.35.91-2
...
* Thu Jul 25 2019 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.32.4-2
...
* Fri Jul 13 2018 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.29.1-2
...
* Tue Feb 13 2018 Björn Esser <besser82@redhat.com> - 3.27.4-4
...
* Tue Nov 08 2017 Kalev Lember <klember@redhat.com> - 3.26.2-1
- Update to 3.26.2
...
* Wed Aug 02 2017 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.25.4-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Binutils_Mass_Rebuild

* Wed Jul 26 2017 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.25.4-2
...
* Fri Feb 10 2017 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.23.3-2
...
* Wed Feb 03 2016 Fedora Release Engineering <releng@lists.fedoraproject.org> - 3.19.4-2
...
* Wed Jul 22 2015 David King <amigadave@redhat.com> - 3.17.2-3
...
* Sat Nov 01 2014 David King <amigadave@redhat.com> - 3.14.1-2
...
* Tue Feb 18 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.90-1
- Update to 3.11.90

* Mon Feb 03 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.5-2
- Require epiphany-runtime rather than the full application

* Mon Feb 03 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.5-1
- Update to 3.11.5

* Thu Jan 30 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.4-3
- Rebuild for libpackagekit-glib soname bump

* Wed Jan 22 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.4-2
- Rebuild with metadata that has the correct screenshot url.

* Thu Jan 16 2014 Richard Hughes <rhughsie@redhat.com> - 3.11.4-1
- Update to 3.11.4

* Tue Dec 17 2013 Richard Hughes <rhughsie@redhat.com> - 3.11.3-1
- Update to 3.11.3

* Tue Nov 19 2013 Richard Hughes <rhughsie@redhat.com> - 3.11.2-1
- Update to 3.11.2

* Tue Oct 29 2013 Richard Hughes <rhughsie@redhat.com> - 3.11.1-1
- Update to 3.11.1
